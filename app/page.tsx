	...
	return (
		...
		<section className="relative">
		  ...
		  <div className="flex flex-wrap gap-8 px-24 py-20">
            <button type="button" className="shadow-md py-8 px-16 rounded-md transistion duration-300 bg-cisco-purple text-white hover:bg-cisco-grey hover:text-black text-2xl">
              Get Started
            </button>
			</div>

          </div>	
		  <div className="flex justify-center flex-1 mb-10 md:mb-16 l	:mb-0 z-10">
